  ...
  <body class="font-sans">
    <div id="root">
      ...
      <div class="flex flex-col min-h-screen dark:bg-gray-700 dark:text-gray-200 transition-color duration-500 ease-in-out">
          ...
          <nav class="flex flex-wrap justify-center items-center p-4 md:flex-nowrap md:justify-between">
            <div class="w-1/2 order-1 md:w-auto">
              <a href="/" class="flex items-center gap-2">
                <img class="mr-3 h-6 w-auto sm:h-9" src="/images/favicon.svg" width="24" height="24" alt="로고 이미지" />
            ...
            <div class="w-auto order-2 text-base mt-4 md:mt-0">
              <ul class="flex items-center gap-6 uppercase">
                ...
                <li class="hover:text-amber-500 hover:font-semibold"><a href="/info">자유게시판</a></li>
                <li class="hover:text-amber-500 a:font-semibold"><a href="/info">질문게시판</a></li>
              </ul>
            </div>
        ...
        <main class="flex-1 min-w-[320px] p-4">
          ...
          <section class="mb-8 p-4">
            <form action="/info/1">
              <div class="my-4">
                ...
                <p class="ml-2 mt-1 text-sm text-red-500 dark:text-red-400">
                  제목은 필수 입니다.
                </p>
              ...
              <div class="my-4">
                ...
                <textarea 
                  ...
                  name="content"
                >Next.js는 React 기반의 풀스택 웹 프레임워크로, 서버 사이드 렌더링(SSR), 정적 생성(SSG), API 라우팅 등을 지원합니다.
페이지 기반 라우팅과 빠른 성능, SEO 최적화 기능이 내장돼 있어 개발과 배포가 매우 효율적입니다.</textarea>
